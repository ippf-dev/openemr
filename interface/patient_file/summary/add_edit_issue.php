...
function sel_diagnosis() {
  <?php if($irow['type'] == 'medical_problem') { ?>
  dlgopen('../encounter/find_code_dynamic.php?codetype=<?php echo attr(collect_codetypes("medical_problem","csv")) ?>', '_blank', 900, 600);
  <?php } else { ?>
  dlgopen('../encounter/find_code_dynamic.php?codetype=<?php echo attr(collect_codetypes("diagnosis","csv")) ?>', '_blank', 900, 600);
  <?php } ?>
}
