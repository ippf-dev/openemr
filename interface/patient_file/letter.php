...
<?php echo $optto; ?>
  ...
  <td>
   <select name='form_format'>
    <option value='html'><?php echo xla('HTML'); ?></option>
    <option value='pdf'><?php echo xla('PDF'); ?></option>
   </select>
  </td>
 ...
 <tr>
  <td colspan='4'>
   ...
   <textarea name='form_body' id="form_body" rows='20' cols='30' style='width:100%'
    title='<?php echo xla('Enter body of letter here'); ?>' /><?php echo $bodytext; ?></textarea>
  </td>
 </tr>
...
<?php echo xlt('Template Name'); ?>: <input type="textbox" size="20" maxlength="30" name="newtemplatename" id="newtemplatename">
<br>
<input type="button" class="savenewtemplate" value='<?php echo xla('Save new template'); ?>'>
<input type="button" class="cancelnewtemplate" value='<?php echo xla('Cancel'); ?>'>
</div>
