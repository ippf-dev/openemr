...
if (!empty($lobj['grp_issue_type'])) $LBF_ISSUE_TYPE = $lobj['grp_issue_type'];
if (!empty($lobj['grp_aco_spec'  ])) $LBF_ACO = explode('|', $lobj['grp_aco_spec']);
...
if (!empty($_POST['bn_save']) || !empty($_POST['bn_save_print']) || !empty($_POST['bn_save_continue']) || !empty($_POST['bn_save_close'])) {
  ...
  while ($frow = sqlFetchArray($fres)) {
    ...
    //
    // The above statement commented out because a LBF plugin might conditionally
