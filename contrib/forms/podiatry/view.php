...
if ($_POST['bn_save']) {
 ...
 //
 if ($formid) {
  $query = "UPDATE form_podiatry SET " .
 ...
 //
  ...
  $query = "INSERT INTO form_podiatry ( " .
  ...
  addForm($encounter, "Podiatry", $newid, "podiatry", $pid, $userauthorized);
 }
...
if ($formid) {
 $row = sqlQuery ("SELECT * FROM form_podiatry WHERE " .
...
<body class="body_top">
<form method="post" action="<?php echo $rootdir ?>/forms/podiatry/new.php?id=<?php echo $formid ?>" onsubmit="return top.restoreSession()">
...
<table border='1' width='95%'>
 ...
 <tr bgcolor='#dddddd'>
  <td colspan='2' align='center'><b>Notes from Podiatrist</b></td>
 </tr>
